...
export default function RecycleModal({ name, isOpen, setIsOpen, setIsDeleteOpen, restore }) {
    ...
    return (
        <Modal isOpen={isOpen} onClose={() => setIsOpen(false)}>
            <div className="modal__header">{isEn ? "Dictionary" : "Словник"} {name}</div>
            <div className="modal__buttons">
                <div className="modal__button modal__delete" onClick={() => setIsDeleteOpen(true)}>{isEn ? "Delete forever" : "Видалити назавжди"}</div>
